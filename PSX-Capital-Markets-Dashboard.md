...
    
      ### 📊 Dashboard Preview
    
    <!-- Replace the URL in the parenthesis below with the actual path to your image asset or hosting URL -->
    ![PSX Capital Markets Dashboard Preview](./assets/psx-dashboard-screenshot.png)
    
